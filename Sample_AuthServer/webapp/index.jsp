            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
						...
						<form action="spDiscovery.jsp" method="get" style="padding: 2rem;">
							<div align="middle">
								<input type=submit value="CONFIGURE" class="btn btn-default btn-lg" title="Configure your vIDM (as Service Provider)">
							</div>
						</form>
                    </div>
                </div>
